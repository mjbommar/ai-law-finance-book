...
\newtcolorbox{examplebox}[1][]{
  ...
  bottom=10pt,
  breakable,
  drop shadow={shadow xshift=1pt, shadow yshift=-1pt, opacity=0.07},
...
% Technical detail box - For optional deeper mechanics (arrays, hardware, algorithms)
\newtcolorbox{technicalbox}[1][]{
  enhanced,
  colback=practice-light,
  colframe=practice-base,
  fonttitle=\bfseries\large,
  coltitle=white,
  boxrule=1.5pt,
  arc=3pt,
  ...
  bottom=10pt,
  breakable,
  drop shadow={shadow xshift=1pt, shadow yshift=-1pt, opacity=0.06},
