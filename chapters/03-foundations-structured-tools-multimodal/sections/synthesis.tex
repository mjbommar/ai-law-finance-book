...
\href{\#}{Chapter~4 (Multimodal Fundamentals)} %TODO: update cross-chapter link to chap:multimodal
will extend these principles to rich media. The techniques transfer directly:
...
Having established \textit{what} the AI outputs (structured data) and \textit{how} it acts (tool calling), the next frontier is optimizing \textit{how we ask}. \href{\#}{Chapter~5 (Prompt Design and Evaluation)} %TODO: update cross-chapter link to chap:prompt-design
will treat prompt engineering as a rigorous discipline, not an art of trial and error.
