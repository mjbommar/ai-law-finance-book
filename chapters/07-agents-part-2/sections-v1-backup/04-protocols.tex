...
\small
\begin{tabular}{p{0.28\textwidth}p{0.15\textwidth}p{0.16\textwidth}p{0.28\textwidth}}
\toprule
\textbf{Signal from workflow} & \textbf{Use} & \textbf{Typical latency} & \textbf{Examples} \\
\midrule
...
\paragraph{Maturity (late 2025)} MCP is production-ready for tool integration across vendors. A2A is earlier: the spec is stable and pilots are active, but cross-vendor reliability remains uneven. Design fallbacks to human coordination where A2A would ideally apply.
