...
\node[font=\scriptsize\itshape, text=gray-700, anchor=south] (rev-arrow) at (0, 3.8) {Decreasing Reversibility};
\draw[->, line width=0.8pt, gray-600] (-4.8, 3.6) -- (4.8, 3.6);

\node[font=\scriptsize\itshape, text=gray-700, anchor=north] (control-arrow) at (0, 3.4) {Increasing Human Control};
\draw[<-, line width=0.8pt, gray-600] (-4.8, 3.2) -- (4.8, 3.2);
...
% Card 1 Header bar
\fill[green-600, rounded corners=4pt]
...
\textcolor{green-900}{AUTONOMOUS}\\[2pt]
...
\textbf{\textsf{Control:}}\\[2pt]
\textcolor{amber-900}{CHECKPOINT REVIEW}\\[2pt]
