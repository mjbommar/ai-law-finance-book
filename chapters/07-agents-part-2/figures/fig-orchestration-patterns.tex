...
\node[flow box, fill=bg-definition, draw=border-definition] (seq-coord) at (-5.5, 2.2) {Coordinator};
...
\node[flow box, fill=bg-definition, draw=border-definition] (seq-synth) at (-5.5, -1.4) {Synthesize};
...
\node[flow box, fill=bg-key, draw=border-key] (par-coord) at (0, 2.2) {Coordinator};
...
\node[flow box, fill=bg-key, draw=border-key] (par-synth) at (0, -0.4) {Synthesize};
...
\node[flow box, fill=bg-example, draw=border-example] (hier-coord) at (5.5, 2.2) {Coordinator};
...
\node[flow box, fill=bg-example, draw=border-example] (hier-synth) at (5.5, -1.2) {Synthesize};
