...
See \Cref{sec:agents2-memory} for detailed treatment of isolation requirements in memory systems. Implementing these isolation requirements involves governance frameworks detailed in the following chapter---\textit{How to Govern an Agent}---which addresses regulation, controls, and compliance structures for agent deployments in regulated industries.
