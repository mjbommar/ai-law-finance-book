...
The architectures below illustrate how components fit together. They represent \textit{design targets}, not claims about what current systems reliably achieve.

Recall the reliability cliff from \Cref{sec:agents2-reliability}: near-perfect success on tasks under 4 minutes, under 10\% success on tasks over 4 hours. These reference architectures describe multi-hour workflows that would require extensive human oversight and intervention with current technology.

Read these as ``how you would design it'' not ``how it works today.'' The failure mode analysis is as important as the architecture itself.
\end{highlightbox}
...
\subsubsection{Ten Questions Applied}
...
Even well-designed systems fail. Understanding failure modes is crucial:
