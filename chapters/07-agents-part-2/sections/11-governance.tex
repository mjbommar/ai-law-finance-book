...
This chapter answered \textit{how to build an agent}. The ten questions (Table~\ref{tab:agents2-governance-mapping}) provide architectural foundations; each creates governance requirements that the architecture must support.
