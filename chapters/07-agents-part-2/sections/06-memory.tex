...
\textbf{Working Memory (Context Window):} The associate has papers spread across their desk: the documents actively in use right now. This immediate context is \textbf{working memory}. In agent systems, working memory takes the form of the \textit{context window}, the tokens currently loaded in the LLM's attention.
