...
These ten questions are not arbitrary. They emerge from what agentic systems are designed to do: augment human professionals, automate routine workflows, or even eventually replace entire organizational functions. Whatever the ambition, the system must handle the same work those humans and organizations currently perform.  For a contract negotiation agent to be successful, it must be able to do what a transactional lawyer does. Similarly, a portfolio monitoring agent must be able to ``act like'' an analyst.
