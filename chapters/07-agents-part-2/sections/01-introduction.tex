...
\midrule
\hyperref[sec:agents2-triggers]{2: Triggers} & How does the agent know when it has work to do? \\
\hyperref[sec:agents2-intent]{3: Intent} & How does the agent understand what is being asked? \\
\hyperref[sec:agents2-perception]{4: Perception} & How does the agent find things out? \\
\hyperref[sec:agents2-action]{5: Action} & How does the agent make things happen? \\
\hyperref[sec:agents2-memory]{6: Memory} & How does the agent remember things? \\
\hyperref[sec:agents2-planning]{7: Planning} & How does the agent break a big job into steps? \\
\hyperref[sec:agents2-termination]{8: Termination} & How does the agent know when it is done? \\
\hyperref[sec:agents2-escalation]{9: Escalation} & How does the agent know when to ask for help? \\
\hyperref[sec:agents2-delegation]{10: Delegation} & How does the agent work with other agents? \\
\hyperref[sec:agents2-governance]{11: Governance} & How do we keep the agent safe? \\
\bottomrule
\end{tabular}
\end{table}
