...
\hypersetup{
  ...
  pdfborder={0 0 0},
  pdftitle={How to Build an Agent: Architectures, Protocols, and Technical Evaluation},
  pdfauthor={},
  pdfsubject={AI Agents, Agent Architecture, MCP, A2A, Agent Evaluation},
  pdfkeywords={agentic AI, AI agents, legal AI, MCP, A2A, agent architecture, agent evaluation}
}
...
\begin{center}
  \begin{tcolorbox}[
    ...
    {\small
      This chapter is Part II of a three-part series from the textbook \textit{Artificial Intelligence for Law and Finance}. Part I (What is an Agent?) provides definitions and foundations. Part III (Chapter 08 --- Agents Part III: How to Govern an Agent) addresses regulation, risk, and deployment.
...
\input{sections/12-synthesis}
\input{sections/13-resources}
