...
General agency definitions must be augmented with legal-specific requirements: \keyterm{attribution} to authoritative sources, \keyterm{auditable provenance}, \keyterm{escalation protocols} recognizing human judgment needs, and \keyterm{confidentiality mechanisms} protecting privilege. These requirements don't change what makes something an agent; they define what makes an agent suitable for professional work.
\end{keybox}
