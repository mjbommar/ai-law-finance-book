...
\begin{definitionbox}[title={\textbf{1957: Intention}}]
...
\begin{definitionbox}[title={\textbf{1958: Legal Agency}}]
...
\begin{definitionbox}[title={\textbf{1963: Causal Theory of Action}}]
...
\begin{definitionbox}[title={\textbf{1974: The Agentic State}}]
...
\begin{definitionbox}[title={\textbf{1976: Principal-Agent Economics}}]
...
\begin{definitionbox}[title={\textbf{1984: Structuration Theory}}]
...
\begin{definitionbox}[title={\textbf{1986: Society of Mind}}]
...
\begin{definitionbox}[title={\textbf{1987: Planning Theory}}]
...
\begin{definitionbox}[title={\textbf{1987: The Intentional Stance}}]
Daniel Dennett's \textit{The Intentional Stance} argued we can treat systems as agents when attributing beliefs and desires yields reliable predictions---providing a pragmatic criterion for agency \parencite{dennett1987intentional}.
\end{definitionbox}

\begin{definitionbox}[title={\textbf{1989: Human Agency}}]
...
\begin{definitionbox}[title={\textbf{1991--1993: Agent-Oriented Programming}}]
...
\begin{definitionbox}[title={\textbf{1995: Intelligent Agents}}]
...
\begin{definitionbox}[title={\textbf{1995: Perception–Action Agents}}]
...
\begin{definitionbox}[title={\textbf{1995: Complex Adaptive Systems}}]
...
\begin{definitionbox}[title={\textbf{1996: Autonomous Agents}}]
Franklin and Graesser distinguished \keyterm{autonomous agents} as systems situated within an environment that sense and act over time in pursuit of their own agendas \parencite{franklin-graesser-1997}.
\end{definitionbox}

\begin{definitionbox}[title={\textbf{1996: Agent-Based Modeling}}]
...
\begin{definitionbox}[title={\textbf{1998: Reinforcement Learning}}]
...
\begin{definitionbox}[title={\textbf{1999: Multi-Agent Systems}}]
...
\begin{definitionbox}[title={\textbf{2000: Physical Agency}}]
...
\begin{definitionbox}[title={\textbf{1998 Roadmap: Agent Definition Consensus}}]
Jennings, Sycara, and Wooldridge's 1998 research roadmap synthesized the agent research community's consensus: an agent is ``an encapsulated computer system that is situated in some environment, and that is capable of flexible, autonomous action in that environment in order to meet its design objectives'' \parencite{jennings1998roadmap,wooldridge1995intelligent}. This definition grounded agent-oriented software engineering (AOSE) work throughout the 2000s.
\end{definitionbox}

\begin{definitionbox}[title={\textbf{2006: Restatement (Third) of Agency}}]
...
\begin{definitionbox}[title={\textbf{2022: The LLM-as-Agent Pattern}}]
...
\begin{definitionbox}[title={\textbf{2023: The Rise of LLM Agents}}]
Xi et al.'s survey ``The Rise and Potential of Large Language Model Based Agents'' documented the emerging architectural consensus: systems using LLMs to iteratively call tools, observe results, and adapt until goals are achieved \parencite{xi2023rise}.
\end{definitionbox}

\begin{definitionbox}[title={\textbf{2024--2025: Commercial Frameworks}}]
LangChain defines agents as systems using LLMs to iteratively call tools until a stop condition is met \parencite{langchain-agents-docs}. OpenAI's Agents SDK describes agents as LLMs configured with instructions and tools, operating in loops where the LLM decides which tools to call based on iterative feedback \parencite{openai-agents-sdk}. This convergence represents an emerging architectural consensus across research and commercial frameworks.
\end{definitionbox}
...
Definitions migrated from delegated proxies (1958) through perception–action systems (1995) to self-directed tool orchestrators (2025). The locus of decision-making shifted progressively toward the agent.
