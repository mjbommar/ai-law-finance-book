...
Psychology's distinctive insight: agency is not merely a property of isolated actions but a stable characteristic of cognitive systems capable of self-regulation. Crucially, agency exists on a spectrum and can be diminished by context \parencite{milgram1974obedience} or enhanced through \keyterm{self-efficacy} beliefs. For AI systems, this highlights how humans \textit{perceive} AI agency, affecting trust and delegation decisions.
...
\begin{tabular}{@{}lp{3.5cm}p{4cm}p{4.5cm}p{6cm}@{}}
\toprule
\rowcolor{white}
...
\textsf{Law} & Low--moderate & Hybrid (principal-agent) & Authority \& fiduciary duty & Liability, professional responsibility \\
...
\textsf{AI} & High & Machine (+ hybrid modern) & Perception-action loops, tools & Task completion, capabilities \\
\bottomrule
\end{tabular}
