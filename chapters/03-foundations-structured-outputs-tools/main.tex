...
\title{
  ...
  {\LARGE\color{primary} Structured Outputs and Tool Use}\\[0.4em]
  {\large\itshape\color{text-secondary} Schemas, Validation, and Function Calling}
  \vspace{0.5em}
}
...
\input{sections/02-grounding-retrieval}
\input{sections/03-evidence-record}
\input{sections/04-structured-outputs}
\input{sections/05-tool-use}
\input{sections/06-pitfalls-practices}
