...
\begin{figure}[t!]
  \centering
  \includegraphics[width=0.58\textwidth]{figures/xi-2023-agent-society.png}
  \caption{\textbf{Xi et al.~(2023): Envisioned agent society.} The survey's opening figure depicts multiple AI agents collaborating in a shared environment: agents plan and execute cooking tasks, perform in bands, discuss projects while selecting tools, and coordinate complex activities. Users participate alongside agents. This vision synthesizes the patterns traced through this historical journey—perception-action cycles, tool orchestration, multi-agent coordination, and human-agent collaboration—into an integrated architectural framework that emerged as the consensus by 2023. Source: \textcite{xi2023rise}, Figure 1.}
  \label{fig:xi-2023-agent-society}
\end{figure}
