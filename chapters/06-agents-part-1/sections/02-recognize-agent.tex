...
\begin{questionbox}[unbreakable,title={\textbf{Q5. Does it adapt (A)?}}]
...
\begin{questionbox}[unbreakable,title={\textbf{Q6. Does it stop/terminate (T)?}}]
