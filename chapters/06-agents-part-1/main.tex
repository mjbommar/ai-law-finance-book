...
% Importance scaling for boxes (visual hierarchy without removing boxes)
% Usage: \begin{keybox}[importance=low] ... \end{keybox}
% Levels: low (subtle), medium (default), high (emphatic)
\tcbset{
...
\title{
  ...
  {\LARGE\color{primary} Part I: What is an Agent?}\\[0.4em]
  {\large\itshape\color{text-secondary} A Conceptual Primer and History}
  \vspace{0.5em}
}
...
\begin{center}
	\begin{tcolorbox}[
		...
		\begin{center}
			...
			{\small\color{text-muted} Version 1.0}
		\end{center}
		...
		% Body text - justified
		{\small
			This chapter is Part I of a three-part series from the textbook \textit{Artificial Intelligence for Law and Finance}, currently under development. Individual chapters are being drafted and refined independently before integration into the complete book. Part II: \textit{How to Build an Agent} and Part III: \textit{How to Govern an Agent} are forthcoming.
