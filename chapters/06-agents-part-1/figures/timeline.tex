...
% Reduce page margins for this landscape page to maximize diagram space
...
\node[event, ai, below=0.5cm of e24] (e25) {\textbf{2025} OpenAI, Anthropic\\ Tools-in-a-Loop};
...
% Restore normal page margins after timeline
\restoregeometry
