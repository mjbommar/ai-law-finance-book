...
\title{
  ...
  {\large\itshape\color{text-secondary} Chat Mechanics and Reasoning Patterns}
  \vspace{0.5em}
}
...
\begin{center}
  \begin{tcolorbox}[
    ...
    \vspace{0.25em}
    {\small
      From single-shot completions to multi-turn chats and structured reasoning. We cover roles, memory, scratchpads, and strategy selection.
    }
  \end{tcolorbox}
\end{center}
...
\input{sections/conversational_models}
\input{sections/reasoning_patterns}
\input{sections/strategy_selection}
