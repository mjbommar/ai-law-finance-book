...
\begin{itemize}
  ...
  \item \textbf{Structured outputs} (Chapter~3): Extracted tables and metadata should conform to defined schemas for downstream integration.
  \item \textbf{Tool use} (Chapter~3): Document parsers, OCR engines, and ASR models act as tools that preprocessing agents invoke.
  \item \textbf{Evidence records} (Chapter~3): Multimodal processing steps---redaction, extraction, transcription---must be logged with the same rigor as LLM inference.
\end{itemize}
