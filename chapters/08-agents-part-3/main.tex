...
\hypersetup{
  ...
  pdfborder={0 0 0},
  pdftitle={Governing AI Agents: Risk, Compliance, and Accountability in Law and Finance},
  pdfauthor={Jillian Bommarito, Daniel Martin Katz, Michael J Bommarito II},
  pdfsubject={AI Agents, AI Governance, Risk Management, Regulatory Compliance, Accountability},
  pdfkeywords={agentic AI, AI governance, legal AI, financial AI, regulatory compliance, AI risk, accountability, law, finance}
}
...
\title{
  ...
  {\LARGE\color{primary} Part III: Governing AI Agents}\\[0.4em]
  {\large\itshape\color{text-secondary} Risk, Compliance, and Accountability in Law and Finance}
  \vspace{0.5em}
}
