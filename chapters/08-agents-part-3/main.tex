...
\hypersetup{
  ...
  pdfborder={0 0 0},
  pdftitle={How to Govern an Agent: Regulation, Controls, Conformance, and Deployment},
  pdfauthor={},
  pdfsubject={AI Agents, AI Governance, Regulatory Compliance, Agent Controls},
  pdfkeywords={agentic AI, AI governance, legal AI, financial AI, regulatory compliance, AI controls, agent deployment, conformance}
}
