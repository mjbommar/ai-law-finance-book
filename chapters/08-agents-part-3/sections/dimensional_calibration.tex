...
Before applying dimensional calibration, verify the system qualifies as an \emph{agentic system} under Part I's framework (GPA+IAT properties). Systems lacking any of these six properties are \emph{not agentic systems}. A single-shot ML model, batch classifier, or non-iterative chatbot requires different governance approaches beyond this chapter's scope. \textbf{Verify GPA+IAT compliance before proceeding to dimensional calibration.}
...
\input{figures/fig-autonomy-hitl}
...
\input{figures/fig-autonomy-hotl}
...
\input{figures/fig-autonomy-hic}
...
\begin{highlightbox}[title={Example: Stateful System}]
