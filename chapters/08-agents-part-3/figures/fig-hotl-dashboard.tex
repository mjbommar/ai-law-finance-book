...
\node[metric value, text=green-900] at ([yshift=0.15cm]m2.center) {847};
\node[metric label] at ([yshift=-0.4cm]m2.center) {Confidence Exits};

% Metric 3: Timeout Exits
\node[metric box] (m3) at (1.2,-1.5) {};
\node[metric value, text=amber-600] at ([yshift=0.15cm]m3.center) {23};
...
\node[alert box=green-900] (a1) at (0.3,-3.7) {
...
\node[status indicator, fill=green-600] at ([xshift=-0.3cm]a1.west) {};

% Alert 2 - Green (normal)
\node[alert box=green-900, below=0.3cm of a1] (a2) {
...
\node[status indicator, fill=green-600] at ([xshift=-0.3cm]a2.west) {};

% Alert 3 - Amber (elevated)
\node[alert box=amber-600, below=0.3cm of a2] (a3) {
...
\node[status indicator, fill=amber-600] at ([xshift=-0.3cm]a3.west) {};

% Alert 4 - Green (normal)
\node[alert box=green-900, below=0.3cm of a3] (a4) {
...
\node[status indicator, fill=green-600] at ([xshift=-0.3cm]a4.west) {};
...
\node[font=\scriptsize, text=gray-600, anchor=north west] at (-5.0,-10.3) {
    \tikz\node[status indicator, fill=green-600] {}; Normal~~
    \tikz\node[status indicator, fill=amber-600] {}; Elevated~~
    \tikz\node[status indicator, fill=red-600] {}; Critical~~
