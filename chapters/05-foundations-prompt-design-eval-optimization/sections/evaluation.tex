...
Before advanced system evaluation, run simple retrieval checks on small, dated corpora: confirm recall@k on known Q\&A items, ensure returned passages carry dates/jurisdictions, and verify quotes/locators match sources. Use the evidence record from \Cref{sec:llmC-evidence} and design tasks that make temporal validity explicit.
