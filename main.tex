...
\subfile{chapters/foundations-llm-primer-mechanics/main}

% Foundations Chapter B — Conversations and Reasoning
\subfile{chapters/foundations-conversations-reasoning/main}

% Foundations Chapter C — Structured Outputs, Tools, and Multimodal
\subfile{chapters/foundations-structured-tools-multimodal/main}

% Foundations Chapter D — Multimodal Fundamentals
\subfile{chapters/foundations-multimodal/main}

% Foundations Chapter E — Prompt Design, Evaluation, and Optimization
\subfile{chapters/foundations-prompt-design-eval-optimization/main}
...
\subfile{chapters/agents-part-2/main}

% Chapter 3: How to Govern an Agent (Part III)
\subfile{chapters/agents-part-3/main}
...
\subfile{chapters/kg-foundations/main}

% KG Chapter 2: Operations with LLMs
\subfile{chapters/kg-operations-llm/main}
