...
\begin{tabular}{@{}>{\sffamily}lp{2.2cm}p{2.4cm}p{3.0cm}p{3.8cm}@{}}
\toprule
\rowcolor{white}
\textbf{Discipline} & \textbf{Autonomy Level} & \textbf{Entity Frame} & \textbf{Key Mechanism} & \textbf{Primary Concern} \\
\midrule
Philosophy & Low--moderate & Human, extensible & Intention \& reasons & Rational causality,\newline responsibility \\
Psychology & Varies by context & Human-centered & Self-regulation \&\newline control & Lived experience, efficacy \\
Law & Low--moderate & Hybrid \newline (principal/agent) & Authority \& \newline fiduciary duty & Liability, \newline professional responsibility \\
Economics & Moderate & Institutional/hybrid & Incentive alignment & Agency costs, \newline information asymmetry \\
Cognitive Science & Moderate--high & Human, \newline generalizable & Plans \& representations & Mental architecture \\
Complex Systems & Moderate--high & Machine/hybrid & Local rules \& \newline emergence & Collective behavior, \newline adaptation \\
Computer Science & Moderate--high & Machine/hybrid & Protocols \& \newline coordination & System organization, \newline communication \\
AI & High & Machine (+ hybrid) & Perception/action loops, tools & Task completion, capabilities \\
\bottomrule
\end{tabular}
\caption{Cross-disciplinary comparison of agency perspectives. Disciplines vary systematically in assumed autonomy (low to high), entity frames (human to machine/hybrid), core mechanisms, and primary concerns. Pattern: human-focused disciplines (philosophy, psychology, law) assume lower autonomy and emphasize responsibility; machine-focused disciplines (AI, complex systems, computer science) assume higher autonomy and emphasize capabilities.}
