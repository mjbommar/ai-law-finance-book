...
For practitioners seeking deeper engagement with these foundations:

\begin{itemize}
  \item \textbf{\textcite{restatement2006agency}, Restatement (Third) of Agency.} The authoritative legal framework for agency relationships, fiduciary duties, and attribution---essential for liability analysis and professional responsibility questions.

  \item \textbf{\textcite{jensen1976theory}, Theory of the Firm.} Principal-agent economics explaining information asymmetry, incentive alignment, and monitoring costs; directly applicable to governance design.

  \item \textbf{\textcite{wooldridge2009introduction}, An Introduction to MultiAgent Systems.} Coordination, negotiation, and communication between agents; practical guidance for enterprise deployments involving multiple specialized agents.

  \item \textbf{\textcite{xi2023rise}, The Rise and Potential of Large Language Model Based Agents.} Contemporary survey connecting classical agent concepts to current LLM-based implementations.
\end{itemize}
