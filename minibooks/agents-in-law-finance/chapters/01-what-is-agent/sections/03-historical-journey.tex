...
\paragraph{1963: Causal Theory of Action}
...
\paragraph{1991--1993: Agent-Oriented Programming}
...
\paragraph{1998 Roadmap: Agent Definition Consensus}
...
\paragraph{2024--2025: Commercial Frameworks}
...
Early agents used explicit rules and plans specified by programmers. Deep RL showed agents learning behaviors through environmental interaction. LLMs shifted the architectural locus of planning and orchestration from programmer-specified logic to learned parameters, changing where decision-making knowledge resides rather than the fundamental agentic capabilities.
