...
This chapter addresses the specific governance challenges posed by \textbf{agentic systems}—AI systems exhibiting all six GPA+IAT properties as defined in Chapter~1. While agentic systems present unique accountability and compliance challenges, they represent only one category within the broader landscape of AI technologies deployed in legal, financial, and audit contexts.
