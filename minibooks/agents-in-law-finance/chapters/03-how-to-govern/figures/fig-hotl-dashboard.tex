...
\begin{tikzpicture}[
    ...
    metric value/.style={font=\large\bfseries\sffamily},
    metric label/.style={font=\scriptsize\sffamily, text=gray-600},
    alert box/.style={
        rounded corners=3pt,
        draw=#1,
        line width=1pt,
...
% Legend
\node[font=\scriptsize\sffamily, text=gray-600, anchor=north west] at (-5.0,-10.3) {
