...
\node[cycle box=definition-base] (cycle1) at (-2.5,0) {
    \textbf{\textcolor{definition-dark}{Cycle 1: Initial Risk Scoring}}
};

\node[detail box=definition-base, anchor=north west] (c1details) at (1.5,0.6) {
...
\node[cycle box=example-dark, below=1.5cm of dec1] (cycle2) {
    \textbf{\textcolor{example-dark}{Cycles 2--N: Adaptive Investigation}}
};

\node[detail box=example-dark, anchor=north west] (c2details) at (1.5,-3.2) {
    \textbf{Actions:}\\
    Request documents\\
...
\draw[loop arrow, rounded corners=6pt] (dec2.west) -- ++(-4.5,0) node[below, font=\scriptsize, text=example-dark] {Next cycle} -- ++(0,2.3) -- (cycle2.west);
