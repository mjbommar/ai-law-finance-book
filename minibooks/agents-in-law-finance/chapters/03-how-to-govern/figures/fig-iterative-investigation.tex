...
\begin{tikzpicture}[
    ...
    label text/.style={font=\tiny\sffamily, text=text-muted}
]
...
\draw[loop arrow, rounded corners=6pt] (dec2.west) -- ++(-3.2,0) node[left, font=\scriptsize\sffamily, text=example-dark] {Next cycle} |- (cycle2.west);
