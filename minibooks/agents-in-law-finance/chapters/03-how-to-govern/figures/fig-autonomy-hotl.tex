...
\textcolor{key-dark}{$\blacktriangleright$} Actions are moderate-consequence or reversible (customer service responses, preliminary data analysis)\\[3pt]
\textcolor{key-dark}{$\blacktriangleright$} Real-time human review would create unacceptable latency but oversight remains necessary\\[3pt]
\textcolor{key-dark}{$\blacktriangleright$} System operates within well-defined boundaries (credit limits, risk parameters)
};
