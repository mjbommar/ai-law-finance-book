...
\begin{tikzpicture}[scale=0.88, every node/.append style={transform shape},
    step box/.style={rounded corners=4pt, draw=#1, line width=1pt, inner sep=8pt, text width=9.5cm, font=\small\sffamily},
    time marker/.style={font=\small\bfseries\sffamily, text=gray-600, anchor=east},
    tier marker/.style={font=\footnotesize\bfseries\sffamily, anchor=west},
