...
\begin{tikzpicture}[scale=0.80, every node/.append style={transform shape},
    remember picture,
    tier circle/.style={circle, minimum size=2.2cm, inner sep=0pt, draw=gray-600, line width=1.5pt, font=\bfseries\small\sffamily, align=center},
    tier box/.style={rounded corners=4pt, draw=#1, line width=1pt, inner sep=8pt, text width=10cm, font=\small\sffamily}
]
