...
\end{tikzpicture}
\caption{Incident report documenting cross-cycle error propagation in an agentic legal research system, following ISO 27001 incident management standards.}
