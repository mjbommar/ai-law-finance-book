...
\begin{table}[htbp]
	...
	\small
	\begin{tabular}{p{0.275\textwidth}p{0.605\textwidth}}
		\toprule
		...
		\hyperref[sec:agents2-intent]{Understanding}            & How does the agent understand what is being asked? \\
		...
		\hyperref[sec:agents2-delegation]{Coordination}         & How does the agent work with other agents?         \\
		\hyperref[sec:agents2-governance]{Governance by Design} & How do we design systems that can be governed?     \\
		\bottomrule
	\end{tabular}
\end{table}
