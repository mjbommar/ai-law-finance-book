...
\Cref{sec:agents2-governance} addresses the architectural patterns that enable governance---logging that spans delegation trees, override mechanisms that work across agent boundaries, and privilege enforcement that contains failures. \href{https://papers.ssrn.com/abstract=5911464}{\textit{Governing Agents}} then develops the policy layer: delegation authorization, identity management, retention requirements, and organizational accountability.
