...
\begin{cautionbox}[title={Hallucination Risk and Mitigation}]
	\glsadd{hallucination}Fabricated citations remain a critical failure mode even with RAG. Studies show that RAG-enabled tools can hallucinate 17--33\% of the time \parencite{dahl2024hallucinations}. The model may generate plausible-sounding citations that do not exist in the retrieved context---or anywhere.
