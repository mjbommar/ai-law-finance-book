...
\begin{tikzpicture}[
	...
	\node[inbox] (input) at (-2.0, 0) {
		...
		\small\textit{``Review the Smith}\\
		\small\textit{acquisition agreement}\\
		\small\textit{for change-of-control}\\
		\small\textit{provisions''}
	};
...
\begin{tikzpicture}[
	...
	\node[inbox] (input) at (-2.0, 0) {
		\textcolor{gray-500}{\tiny\sffamily\bfseries USER INSTRUCTION}\\[4pt]
		\small\textit{``Review this credit}\\
		\small\textit{agreement for risks''}
	};
