...
\node[font=\scriptsize\itshape\sffamily, text=text-secondary, anchor=south] (rev-arrow) at (0, 3.8) {Decreasing Reversibility};
\draw[->, line width=0.8pt, text-muted] (-4.8, 3.6) -- (4.8, 3.6);

\node[font=\scriptsize\itshape\sffamily, text=text-secondary, anchor=north] (control-arrow) at (0, 3.4) {Increasing Human Control};
