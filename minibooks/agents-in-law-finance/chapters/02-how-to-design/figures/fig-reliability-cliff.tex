...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}[
    ...
    % Zone annotations
    \node[example-dark, font=\small\bfseries\sffamily] at (1, 4.25) {Safe Zone};
    \node[example-dark, font=\footnotesize\sffamily] at (1, 3.75) {$\sim$95\% success};

    \node[caution-dark, font=\small\bfseries\sffamily] at (9, 4.25) {Unreliable};
    \node[caution-dark, font=\footnotesize\sffamily] at (9, 3.75) {$\sim$10\% success};
