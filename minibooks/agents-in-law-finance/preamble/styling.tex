...
% Section entries (reduced indent to fit within 0.5" outer margin)
\titlecontents{section}
  [1.5em]
  {\vspace{0.3em}}
  {\color{primary}\contentslabel{2.2em}}
  {}
  {\titlerule*[0.75pc]{.}\contentspage}

% Subsection entries (reduced indent to fit within 0.5" outer margin)
