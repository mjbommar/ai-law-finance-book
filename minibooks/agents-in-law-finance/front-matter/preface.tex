...
This mini-book is extracted from a forthcoming textbook, \textit{Artificial Intelligence for Law and Finance}, and revised to stand alone. The full work covers foundational topics---machine learning, natural language processing, knowledge representation---alongside domain applications in legal research, contract analysis, regulatory compliance, and financial modeling. We selected these chapters on agents because they form a self-contained arc: what agents are, how to build them, and how to govern them responsibly.
...
For readers who want hands-on implementation, the forthcoming textbook includes a companion website with working source code, interactive exercises, and practical tutorials. That material will satisfy the appetite for technical depth while this mini-book provides the conceptual foundation that makes implementation choices intelligible.
