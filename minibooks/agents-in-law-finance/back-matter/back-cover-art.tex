% ============================================================================
% BACK COVER ART - Drawn at origin for 6x9 trim area
% ============================================================================
...
\begin{scope}[shift={(0.45in, 3.15in)}]
	...
	\fill[white, opacity=0.1, rounded corners=6pt] (0, 0) rectangle (5.1in, 5.1in);
	% Subtle border
	\draw[white, opacity=0.24, line width=0.5pt, rounded corners=6pt] (0, 0) rectangle (5.1in, 5.1in);
...
\begin{scope}[shift={(0.45in, 0.65in)}]
	...
	\fill[white, opacity=0.1, rounded corners=6pt] (0, 0) rectangle (5.1in, 2.3in);
	\draw[white, opacity=0.24, line width=0.5pt, rounded corners=6pt] (0, 0) rectangle (5.1in, 2.3in);
...
\node[anchor=south east, inner sep=0pt] at (5.55in, 0.2in) {
	{\rmfamily\fontsize{8.5}{10}\selectfont\color{TextMuted}ISBN 979-8-9943457-0-2}
};
