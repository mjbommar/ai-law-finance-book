...
\begin{center}
\small
\begin{tabular}{@{}>{\raggedright}p{2.2cm}p{2.2cm}p{2.2cm}p{3.6cm}@{}}
\toprule
\textbf{Task Type} & \textbf{Strategy} & \textbf{Context} & \textbf{Rationale} \\
\midrule
Chatbots / Creative & Zero/few-shot & Sliding window & Latency critical; errors low-risk \\
\addlinespace
Math / Coding & Chain-of-Thought & K-NN few-shot & Precision key; users tolerate delay \\
\addlinespace
Medical / Finance & Self-Consistency & Vector retrieval & \textbf{High risk}; error cost high \\
\addlinespace
Research Assist. & ReAct & Long-term memory & Tools needed for live data \\
\addlinespace
Complex Planning & Tree of Thoughts & Full replay & Exploration; latency acceptable \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{keybox}[title={Legal AI Strategies}]
\begin{itemize}
...
\begin{keybox}[title={Financial AI Strategies}]
\begin{itemize}
...
\begin{highlightbox}[title={Governance Considerations}]
This chapter provides foundational strategies. For comprehensive governance frameworks covering regulatory requirements, risk assessment methodologies, incident response protocols, and organizational oversight structures, see our companion volume, \textit{Agentic AI in Law and Finance}.
\end{highlightbox}
