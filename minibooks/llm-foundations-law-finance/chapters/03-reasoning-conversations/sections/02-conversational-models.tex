...
\begin{figure}[htbp]
  \centering
  \resizebox{0.95\textwidth}{!}{\input{chapters/03-reasoning-conversations/figures/fig-lost-middle}}
...
\begin{highlightbox}[title={Client Interview Memory}]
...
\begin{figure}[htbp]
  \centering
  \resizebox{0.85\textwidth}{!}{\input{chapters/03-reasoning-conversations/figures/fig-context-assembly}}
