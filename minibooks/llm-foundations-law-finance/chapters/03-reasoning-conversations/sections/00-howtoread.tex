...
\begin{highlightbox}[colback=bg-definition, colframe=definition-base, title={Path 1: Practitioner Quick Start (30--40 minutes)}]
...
\begin{highlightbox}[colback=bg-example, colframe=example-base, title={Path 2: Full Technical Understanding (60--75 minutes)}]
...
\begin{highlightbox}[colback=bg-note, colframe=border-note, title={Path 3: Governance and Risk Focus (25--35 minutes)}]
