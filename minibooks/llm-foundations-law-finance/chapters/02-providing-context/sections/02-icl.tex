...
\begin{keybox}[title={The Context Window as a Programming Interface}]
...
\begin{tikzpicture}[
    node distance=0.3cm,
    box/.style={rectangle, draw=definition-dark, fill=definition-light, minimum width=3.2cm, minimum height=1.2cm, align=center, font=\small},
...
\begin{cautionbox}[title={ICL Does Not Guarantee Factual Accuracy}]
