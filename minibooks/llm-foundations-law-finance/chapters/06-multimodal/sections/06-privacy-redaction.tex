...
\begin{keybox}[title={Redaction Checklist}]
\begin{itemize}
...
\paragraph{Integration with Evidence Records.} Redaction events should be captured in the canonical evidence record (see Chapter~4). When a document is processed:
\begin{itemize}
...
\begin{highlightbox}[title={MNPI Detection}]
...
\begin{keybox}[title={Cross-Border Checklist}]
\begin{itemize}
