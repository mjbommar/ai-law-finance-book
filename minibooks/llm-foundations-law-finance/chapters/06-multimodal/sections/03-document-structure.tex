...
\begin{description}
  ...
  \item[Vision-First (VLM)] Screenshot pages and process through frontier vision-language models. ``Human-like'' understanding of layout but slow, expensive, and limited by context windows.
\end{description}
\end{definitionbox}
...
\begin{highlightbox}[title={Structure Checklist}]
\begin{itemize}
