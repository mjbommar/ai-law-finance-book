...
We catalog architectural patterns for LLM-based systems---from simple direct prompting to modular pipelines---with guidance on when to use each. This section focuses on operationalizing the reasoning patterns introduced in Chapter~3.
...
\paragraph{Optimization and Change Management (Section~\ref{sec:llmD-opt}).}
...
\begin{itemize}
  ...
  \item Grounding and retrieval-augmented generation (Chapter~2)
  \item Conversational patterns and reasoning strategies (Chapter~3)
  \item Structured outputs and evidence records (Chapter~4)
  \item Tool use and function calling (Chapter~5)
  \item Multimodal document processing (Chapter~6)
\end{itemize}
...
\begin{itemize}
  \item \textbf{Agentic architectures}: Multi-step autonomous systems are covered in our companion volume, \textit{Agentic AI in Law and Finance}.
