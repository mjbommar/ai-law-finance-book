...
\paragraph{Model Dependency.} Prompts are coupled to specific model versions. A prompt tuned for one model may perform poorly on another. Model updates (even minor version bumps) can change behavior, requiring re-validation.
...
\centering
\small
\begin{tabular}{@{}p{2.8cm}p{4.0cm}p{3.7cm}@{}}
\toprule
...
\midrule
v1.2 & v3.0 & v1.1 & gpt-5-2025-06 & Production \\
v1.3 & v3.0 & v1.1 & gpt-5-2025-06 & Staging \\
v1.2 & v3.1 & v1.1 & gpt-5-2025-06 & Deprecated \\
v1.3 & v3.1 & v1.2 & gpt-5-mini-2025-06 & Testing \\
\bottomrule
\end{tabular}
