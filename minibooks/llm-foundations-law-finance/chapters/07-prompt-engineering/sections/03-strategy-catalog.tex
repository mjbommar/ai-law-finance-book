...
\small
\begin{tabular}{@{}p{2cm}p{2.2cm}p{1.8cm}p{1.6cm}p{3.5cm}@{}}
\toprule
...
\addlinespace
Self-Consistency & Explicit (N paths) & High & High & Critical decisions \\
\addlinespace
ReAct & Explicit + Tools & Med-High & Med-High & Tool-using workflows \\
\addlinespace
ToT/GoT & Explicit (branching) & Very High & Very High & Exploration, planning \\
\addlinespace
