...
\begin{figure}[htbp]
  \centering
  \resizebox{0.9\textwidth}{!}{\input{chapters/02-conversations-reasoning/figures/fig-reasoning-patterns}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{0.75\textwidth}{!}{\input{chapters/02-conversations-reasoning/figures/fig-react-loop}}
