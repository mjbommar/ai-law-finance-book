...
\paragraph{Where to go deeper.} Chapter~2 (Conversations and Reasoning) provides the primary treatment of ``Lost in the Middle'' in the context of prompt assembly, memory strategies, and instruction placement.
