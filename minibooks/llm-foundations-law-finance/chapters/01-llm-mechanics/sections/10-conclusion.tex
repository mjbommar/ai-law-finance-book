...
\paragraph{Agentic Systems.} Our companion volume, \textit{Agentic AI in Law and Finance}, introduces LLMs as components in autonomous systems that can take actions through tool calling. The mechanical understanding of structured outputs and sampling from this chapter becomes essential for reliable tool invocation and governance of autonomous agents.
