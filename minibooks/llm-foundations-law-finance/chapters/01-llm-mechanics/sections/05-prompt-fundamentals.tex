...
\midrule
1: Zero-shot & Freeform text & Freeform text & None (manual review) & 1--3 \\
2: Few-shot & Examples + text & Freeform text & Low (human eval) & 2--3 \\
3: Structured Input & JSON/XML input & Freeform text & Medium (input validation) & 4, 7 \\
4: Structured I/O & JSON/XML input & JSON/XML output & High (schema validation) & 4, 7 \\
5: Modular & Decomposed pipeline & Structured, composable & Full (unit + integration tests) & 7 \\
\bottomrule
\end{tabular}
\end{table}
