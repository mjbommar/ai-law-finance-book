...
\begin{highlightbox}[colback=bg-definition, colframe=definition-base, title={Quick Implementation}]
...
\begin{highlightbox}[colback=bg-note, colframe=border-note, title={Security Focus}]
