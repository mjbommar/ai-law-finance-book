...
\begin{highlightbox}[colback=bg-definition, colframe=definition-base, title={Path 1: Production Retrieval (20--30 minutes)}]
...
\begin{highlightbox}[colback=bg-example, colframe=example-base, title={Path 2: Structured Outputs (25--35 minutes)}]
